...
public class p4_Mapper extends Mapper<LongWritable, Text, Text, FloatWritable> {
    ...
    protected void setup(Context context) throws IOException {
        ...
        while (lineReader.readLine(line) > 0) {
            ...
            String local = values[2].trim();
            Department department = new Department(id, dept, local);
    ...
    protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
        ...
        if (isContain) {
            ...
            // key为城市, value为salary
            context.write(new Text(outputDept.getLocation()), new FloatWritable(salary));
        }
    }
}
