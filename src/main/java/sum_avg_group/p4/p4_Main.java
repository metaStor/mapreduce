...
public class p4_Main extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        // Jar class
        job.setJarByClass(p4_Main.class);
        // Mapper
        job.setMapperClass(p4_Mapper.class);
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(FloatWritable.class);
        // Reducer
        job.setReducerClass(p4_Reducer.class);
    ...
    public static void main(String[] args) throws Exception {
        System.exit(ToolRunner.run(new p4_Main(), args));
    }
